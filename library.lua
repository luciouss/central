...
menu.outline.outline.main.text.Text = "central.top"
...
function library:saveConfig()
    ...
    writefile("central_configs/"..tostring(game.GameId).."/"..name..".ct",game:GetService("HttpService"):JSONEncode(jig))
    library:notify("Succesfully saved config "..name..".ct!")
    library:refreshConfigs()
end

function library:loadConfig()
    local name = library.flags["selected_config"]
    if not isfile("central_configs/"..tostring(game.GameId).."/"..name..".ct") then
        library:notify("Config file not found!")
        return
    end
    local config = game:GetService("HttpService"):JSONDecode(readfile("central_configs/"..tostring(game.GameId).."/"..name..".ct"))
    ...
    library:notify("Succesfully loaded config "..name..".ct!")
end

function library:refreshConfigs()
    local tbl = {}
    for i,v in next, listfiles("central_configs/"..tostring(game.GameId)) do
...
function library:deleteConfig()
    if isfile("central_configs/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".ct") then
        delfile("central_configs/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".ct")
        library:refreshConfigs()
    end
end
