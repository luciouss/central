...
central, a free and open source Counter Blox script created by sjors, pasted by lucious

alora discord: https://discord.gg/m3aMvdynrf -- not changing these :)
cuteware discord: https://discord.gg/nyZaeASbsk -- not changing these :)
...
local ver = "1.0.2"
--files
if not isfolder("central_configs") then
    makefolder("central_configs")
end
if not isfolder("central_configs/"..tostring(game.GameId)) then
    makefolder("central_configs/"..tostring(game.GameId))
end
--vars
local library,menu,tabholder = loadstring(game:HttpGet("https://raw.githubusercontent.com/luciouss/central/main/library.lua"))()
...
rifleGroup:addSlider({text = "Aim Assist FOV",flag = "rifle_assist_fov",min = 0,max = 180,value = 100})
rifleGroup:addSlider({text = "Silent Aim FOV",flag = "rifle_silent_fov",min = 0,max = 180,value = 25})
...
pistolGroup:addSlider({text = "Aim Assist FOV",flag = "pistol_assist_fov",min = 0,max = 180,value = 100})
pistolGroup:addSlider({text = "Silent Aim FOV",flag = "pistol_silent_fov",min = 0,max = 180,value = 25})
...
heavypGroup:addSlider({text = "Aim Assist FOV",flag = "heavyp_assist_fov",min = 0,max = 180,value = 100})
heavypGroup:addSlider({text = "Silent Aim FOV",flag = "heavyp_silent_fov",min = 0,max = 180,value = 25})
...
awpGroup:addSlider({text = "Aim Assist FOV",flag = "awp_assist_fov",min = 0,max = 180,value = 100})
awpGroup:addSlider({text = "Silent Aim FOV",flag = "awp_silent_fov",min = 0,max = 180,value = 25})
...
scoutGroup:addSlider({text = "Aim Assist FOV",flag = "scout_assist_fov",min = 0,max = 180,value = 100})
scoutGroup:addSlider({text = "Silent Aim FOV",flag = "scout_silent_fov",min = 0,max = 180,value = 25})
...
otherGroup:addSlider({text = "Aim Assist FOV",flag = "other_assist_fov",min = 0,max = 180,value = 100})
otherGroup:addSlider({text = "Silent Aim FOV",flag = "other_silent_fov",min = 0,max = 180,value = 25})
...
movementGroup:addToggle({text = "Jump bug",flag = "jump_bug"})
movementGroup:addToggle({text = "Edge bug",flag = "edge_bug"})
...
otherGroup2:addButton({text = "Unlock All",callback = function() 
...
function onStep()
    ...
    if library.flags["watermark_enabled"] then
        ...
        aloraWatermark.Text = "central.top | "..ver.." | "..hours..":"..minutes..":"..seconds
    end
end
